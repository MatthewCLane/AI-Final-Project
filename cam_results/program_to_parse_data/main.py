...
with open("FinalSamples.txt") as sampleFile:        # this technique auto closes the file when done (with...as...)
...
writeFile = open("FinalSamples_Ordered.txt", "w")
for flo in listOfAverageAcc:                            # looping through list of averages
    tempFloat_asString = "Average Acc: " + str(flo)     # casting float from list as string
    with open("FinalSamples.txt") as sampleFile:        # looping through file
