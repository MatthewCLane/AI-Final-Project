'''
This file was used to determine the best kernel size between 3 different settings.
This is also when we started saving the best model (best model loss)
...
fileOutput = 'D:\\model saves kernel\\info.txt'
...
while iteration < 2:
    ...
    for i in kernel1:
        ...
        cnn = Conv2D(counter, (i, i), activation='relu', strides=(1, 1),
                     padding='same')(input1)
        cnn = Conv2D(counter2, (i, i), activation='relu', strides=(1, 1),
                     padding='same')(cnn)
        cnn = MaxPool2D((2, 2))(cnn)

        cnn = Conv2D(counter, (i+1, i+1), activation='relu', strides=(1, 1),
                     padding='same')(cnn)
        cnn = Conv2D(counter2, (i+1, i+1), activation='relu', strides=(1, 1),
                     padding='same')(cnn)
        cnn = MaxPool2D((2, 2))(cnn)
        ...
        checkpoint_filepath = 'D:\\model saves kernel\\tmp\\checkpoint\\adamaxE12085.09BEST_L1N150L2N610_' + str(
            counter) + '_' \
                         + str(counter2) + 'K1' + str(i) + 'K2' + str(i + 1) + \
                         '_' + str(iteration) + '.h5'
        ...
        accuracyString = 'D:\\model saves kernel\\Accuracy\\adamE12085.09accuracyScores_L1N150L2N610_' + str(
            counter) \
                         + '_' + str(counter2) + 'K1' + \
                         str(i) + 'K2' + str(i+1)+ '_' + str(iteration) + '.png'
        ...
        accuracyString = 'D:\\model saves kernel\\loss\\adamaxE12085.09lossScores_L1N150L2N610_' + str(
            counter) + '_' \
                         + str(counter2) + 'K1' + str(i) + 'K2' + str(i + 1) + \
                         '_' + str(iteration) + '.png'
        plt.savefig(accuracyString, bbox_inches='tight')
        ...
        plt.ylabel('Actual')
        accuracyString = 'D:\\model saves kernel\\Confusion Matrix\\adamE12085.09confusionMatrix_L1N150L2N610_' + \
                         str(counter) \
                         + '_' + str(counter2) + 'K1' + str(i) + 'K2' + str(i + 1) + '_' + str(iteration) + '.png'
        plt.savefig(accuracyString, bbox_inches='tight')
        # plt.show()
        file.close()
...
while iteration < 2:
    ...
    for i in kernel1:
        ...
        checkpoint_filepath = 'D:\\model saves kernel\\tmp\\checkpoint\\adamaxE12085.09BEST_L1N150L2N610_' + str(
            counter) + '_' \
                              + str(counter2) + 'K1' + str(i) + 'K2' + str(i) + \
                              '_' + str(iteration) + '.h5'
        # https://www.geeksforgeeks.org/keras-fit-and-keras-fit_generator/
        # https://www.geeksforgeeks.org/keras-fit-and-keras-fit_generator/
        earlyStopping = EarlyStopping(monitor='val_loss', patience=120, verbose=0, mode='min')
        ...
        model.save('D:\\model saves kernel\\adamE12085.09L1N150L2N610_' + str(counter) + '_' + str(counter2) + 'K1' +
                   str(i) + 'K2' + str(i) + '_' + str(iteration) + '.h5')
        ...
        accuracyString = 'D:\\model saves kernel\\Accuracy\\adamE12085.09accuracyScores_L1N150L2N610_' + str(
            counter) \
                         + '_' + str(counter2) + 'K1' + \
                         str(i) + 'K2' + str(i) + '_' + str(iteration) + '.png'
        plt.savefig(accuracyString, bbox_inches='tight')
        # plt.show()
        ...
        accuracyString = 'D:\\model saves kernel\\Confusion Matrix\\adamE12085.09confusionMatrix_L1N150L2N610_' + \
                         str(counter) \
                         + '_' + str(counter2) + 'K1' + str(i) + 'K2' + str(i) + '_' + str(iteration) + '.png'
        plt.savefig(accuracyString, bbox_inches='tight')
        # plt.show()
        file.close()
...
while iteration < 2:
    ...
    for i in kernel1:
        ...
        checkpoint_filepath = 'D:\\model saves kernel\\tmp\\checkpoint\\adamaxE12085.09BEST_L1N150L2N610_' + str(
            counter) + '_' \
                              + str(counter2) + 'K1' + str(i+1) + 'K2' + str(i) + \
                              '_' + str(iteration) + '.h5'
        # https://www.geeksforgeeks.org/keras-fit-and-keras-fit_generator/
        ...
        model.save('D:\\model saves kernel\\adamE12085.09L1N150L2N610_' + str(counter) + '_' + str(counter2) + 'K1' +
                   str(i+1) + 'K2' + str(i) + '_' + str(iteration) + '.h5')
        ...
        accuracyString = 'D:\\model saves kernel\\Accuracy\\adamE12085.09accuracyScores_L1N150L2N610_' + str(
            counter) \
                         + '_' + str(counter2) + 'K1' + \
                         str(i+1) + 'K2' + str(i) + '_' + str(iteration) + '.png'
        plt.savefig(accuracyString, bbox_inches='tight')
        # plt.show()
        ...
        accuracyString = 'D:\\model saves kernel\\Confusion Matrix\\adamE12085.09confusionMatrix_L1N150L2N610_' + \
                         str(counter) \
                         + '_' + str(counter2) + 'K1' + str(i+1) + 'K2' + str(i) + '_' + str(iteration) + '.png'
        plt.savefig(accuracyString, bbox_inches='tight')
        # plt.show()
        file.close()
